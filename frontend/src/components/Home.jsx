        ...
        <>
          <section>
            <div className="sort">
              <button
                className="sort_veg"
                data-active={showVegOnly}
                onClick={handleToggleVegOnly}
              >
                <i className="fa fa-leaf mr-1" aria-hidden="true"></i>{" "}
                {showVegOnly ? "Show All" : "Pure Veg"}
              </button>

              <button className="sort_rev" onClick={handleSortByReviews}>
                <i className="fa fa-comments mr-1" aria-hidden="true"></i> Sort
                By Reviews
              </button>

              <button className="sort_rate" onClick={handleSortByRatings}>
                <i className="fa fa-star mr-1" aria-hidden="true"></i> Sort By
                Ratings
              </button>
            </div>

            <div className="restaurant-grid mt-4">
              ...
              {isAuthenticated && user && user.role === "admin" && (
                <div className="add-restaurant-card" onClick={handleOpenCreate}>
                  <h1>+</h1>
